...
We can also see the among-module (z) and within-module (c) connectivity of different patches. Interestingly, module 9 and 1 and 3 tend to act as links among modules. This makes sense as patch 9 is the interface between Forest and grassland boundaries. Note c can't be computed for modules composed by a single patch, and hence patch 5 is not plotted.
